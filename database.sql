...
INSERT INTO `user` VALUES (1,'Morin','Jean François','Chez lui','JF','Saintes',14000,707070707,'morinJF@JF.com','$2y$10$ChTC9pnYaSm6iiy8IawEYeGN1BkZldDe1OQcI9LdfG7DhjMx74Y5W');
INSERT INTO `donation` VALUES (1,'Apple','iPhone 15++maxpro no fake','Un super téléphone gratouit','2022-05-13 11:24:50',1,'Saintes',1),(2,'Samsung','a1','Marche correctement. Numero de la pizzeria pré enregistré','2022-05-13 11:25:49',1,'Marseille',1),(3,'Vieux Motorola','inconnu','Il est fatigué mais possède un beau clapet tres vintage.','2022-05-13 11:27:47',1,'Saintes',1),(4,'Nokia','3310','Parfait pour des parties endiablées de snake','2022-05-13 11:28:27',1,'Saintes',1),(6,'Oppo','x4','Je donne le tel de mon fils qui traîne trop sur tiktok, je donne aussi mon fils.','2022-05-13 11:30:50',1,'Saintes',1);
